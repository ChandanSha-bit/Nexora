    ...
    <div className="min-h-screen bg-[#080b10] flex items-center justify-center p-4">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-600 text-sm mt-1">Join Nexora and start chatting</p>
        </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input type="text" value={formData.name} onChange={(e) => setFormData({ ...formData, name: e.target.value })} className={inputCls} placeholder="John Doe" />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input type={showPassword ? 'text' : 'password'} value={formData.password} onChange={(e) => setFormData({ ...formData, password: e.target.value })} className={`${inputCls} pr-10`} placeholder="Min 6 characters" />
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-600" />
                <input type={showConfirm ? 'text' : 'password'} value={formData.confirmPassword} onChange={(e) => setFormData({ ...formData, confirmPassword: e.target.value })} className={`${inputCls} pr-10`} placeholder="Repeat password" />
                <button type="button" onClick={() => setShowConfirm(!showConfirm)} className="absolute right-3.5 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-400 transition-colors" tabIndex="-1">
